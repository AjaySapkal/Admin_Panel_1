<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="BuissnessAdminPanel.Edit" %>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Edit Info Form </h3>
            </div>
            <div class="row">
                    ...
                    <form class="forms-sample" runat="server">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" class="form-control" id="txtphone" placeholder="Phone"></asp:TextBox>
                            </div>
                           <div class="form-group">
